...
<div class="card">
    ...
    <div class="card-body">
    {!! Form::model($model,[
                     'action'=>'WebController\LessonController@store',
                     'id'=>'myForm',
                     'method'=>'POST',
                     'files'=>true ,
     ...
     <div class="form-group">
      ...
      {!! Form::select('category_id' ,[''=>trans('admin/lessons/create.text_cat')] + $categories , old('category_id') , ['class' => 'form-control style-inp']) !!}
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        {!! Form::select('status' , ['1'=>trans('admin/lessons/create.text_published') , '0'=>trans('admin/lessons/create.text_hidden')] , old('status') ,['class'=>"form-control style-inp"]) !!}
