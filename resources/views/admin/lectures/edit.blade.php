...
<div class="card">
    ...
    <div class="card-body">
    {!! Form::model($model,[
                     'action'=>['WebController\LectureController@update' , $model->id],
                     'id'=>'myForm',
                     'method'=>'PUT',
                     'files'=>true ,
     ...
     <div class="form-group">
      ...
      {!! Form::select('category_id' , [''=>trans('admin/lectures/create.text_cat')] + $category  , old('category_id' , $model->category_id) , ['class' => 'form-control style-inp']) !!}
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <ul style="list-style: none ; padding:0">
          ...
          @endforeach
          @else
          <li style="cursor: context-menu;color: red;"> {{ trans('admin/lectures/edit.text_no_files')  }} </li>
          @endif
        </ul>
      </div>
      ...
      <div class="form-group">
        ...
        {!! Form::select('status' , ['1'=>trans('admin/lectures/create.text_published') , '0'=>trans('admin/lectures/create.text_hidden')] , old('status' , $model->status) ,['class'=>"form-control style-inp"]) !!}
